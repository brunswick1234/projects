...
<form name="create_event" action="/mission/${mission.id}/create_invitation" method="POST">
    <div id="admin_left_pane" class="fieldset_without_border">
        ...
        <ol>
            <li>
                ...
                <input id="recipientEmail" name="recipientEmail" type="text" value="${recipientEmail!""}">
            </li>
            <li>
                <label for="status" class="bold">Status(created/send/accepted/declined):*</label>
                <input id="status" name="status" type="text" value="${status!""}">
            </li>
            <li>
...
<#if errorMsg?? && errorMsg?has_content>
    ...
    <div id="buttonwrapper">
        <button type="submit" id ="createInvitation">Create New Invitation</button>
        <a href="/">Cancel</a>
    </div>
</form>
